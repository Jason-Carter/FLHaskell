--
-- Questions posed by BillyBadBoy in the following gist:
--
--    https://gist.github.com/BillyBadBoy/85cb22ca4184a5aa760224ace97e0db8
--
...
middle x y z = min (min (max x y) (max y z)) (max x z)
